...
public class SupportFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (activity instanceof XposedDropdownNavActivity)
			((XposedDropdownNavActivity) activity)
					.setNavItem(XposedDropdownNavActivity.TAB_SUPPORT);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		txtModuleSupport.setText(getString(
				R.string.support_modules_description,
		...
		txtModuleSupport.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(XposedInstallerActivity.EXTRA_SECTION,
						XposedDropdownNavActivity.TAB_MODULES);
