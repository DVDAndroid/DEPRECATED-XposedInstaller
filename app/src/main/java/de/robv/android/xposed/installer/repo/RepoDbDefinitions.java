...
public class RepoDbDefinitions {
	...
	static final String SQL_CREATE_TABLE_MODULES = "CREATE TABLE "
			...
			+ ModulesColumns.SUMMARY + " TEXT, " + ModulesColumns.DESCRIPTION
			+ " TEXT, " + ModulesColumns.DESCRIPTION_IS_HTML
			+ " INTEGER DEFAULT 0, " + ModulesColumns.AUTHOR + " TEXT, "
			+ ModulesColumns.SUPPORT + " TEXT, " + ModulesColumns.CREATED
			+ " INTEGER DEFAULT -1, " + ModulesColumns.UPDATED
			+ " INTEGER DEFAULT -1, " + ModulesColumns.PREFERRED
			+ " INTEGER DEFAULT 1, " + ModulesColumns.LATEST_VERSION
			+ " INTEGER REFERENCES " + ModuleVersionsColumns.TABLE_NAME + ", "
			+ "UNIQUE (" + ModulesColumns.PKGNAME + ", "
			+ ModulesColumns.REPO_ID + ") ON CONFLICT REPLACE)";
	...
	static final String SQL_CREATE_INDEX_MODULE_VERSIONS_MODULE_ID = "CREATE INDEX "
			+ ModuleVersionsColumns.IDX_MODULE_ID
			+ " ON "
			+ ModuleVersionsColumns.TABLE_NAME
			+ " ("
	...
	static final String SQL_CREATE_TEMP_VIEW_INSTALLED_MODULES_UPDATES = "CREATE TEMP VIEW "
			...
			+ ModulesColumns._ID
			+ " AS "
			+ InstalledModulesUpdatesColumns.MODULE_ID
			+ ", "
			+ "i."
			+ InstalledModulesColumns.PKGNAME
			+ " AS "
			+ InstalledModulesUpdatesColumns.PKGNAME
			+ ", "
			+ "i."
			+ InstalledModulesColumns.VERSION_CODE
			+ " AS "
			...
			+ ", "
			+ "i."
			+ InstalledModulesColumns.VERSION_NAME
			+ " AS "
			+ InstalledModulesUpdatesColumns.INSTALLED_NAME
			+ ", "
			+ "v."
			+ ModuleVersionsColumns._ID
			+ " AS "
			+ InstalledModulesUpdatesColumns.LATEST_ID
			+ ", "
			+ "v."
	...
	public static interface InstalledModulesUpdatesColumns {
		public static final String VIEW_NAME = InstalledModulesColumns.TABLE_NAME
				+ "_updates";
